...
class BaseModelOutput(ModelOutput):
    ...
    summed_norms: Optional[Tuple[torch.FloatTensor]] = None
...
class BaseModelOutputWithPastAndCrossAttentions(ModelOutput):
    ...
    norms: Optional[Tuple[torch.FloatTensor]] = None
    summed_norms: Optional[Tuple[torch.FloatTensor]] = None
    cross_norms: Optional[Tuple[torch.FloatTensor]] = None
    cross_summed_norms: Optional[Tuple[torch.FloatTensor]] = None
...
class Seq2SeqModelOutput(ModelOutput):
    ...
    cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
    decoder_norms: Optional[Tuple[torch.FloatTensor]] = None
    decoder_summed_norms: Optional[Tuple[torch.FloatTensor]] = None
    cross_norms: Optional[Tuple[torch.FloatTensor]] = None
    cross_summed_norms: Optional[Tuple[torch.FloatTensor]] = None
    encoder_last_hidden_state: Optional[torch.FloatTensor] = None
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    encoder_norms: Optional[Tuple[torch.FloatTensor]] = None
    encoder_summed_norms: Optional[Tuple[torch.FloatTensor]] = None
